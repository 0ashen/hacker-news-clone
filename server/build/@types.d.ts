...
export declare type HackerNewsItemId = number;
/** Unique ID of a Hacker News user, alphanumeric */
export declare type HackerNewsUserId = string;
/** Hacker News category */
export declare type HackerNewsStoryType = "top" | "new" | "best" | "ask" | "show" | "job";
/** Possible type of a Hacker News item */
export declare type HackerNewsItemType = "job" | "story" | "comment" | "poll" | "pollopt";
/**
 * A Hacker news item
 */
